...
export class MessageService {
    ...
    public getAllMessages(): Observable<Message[]> {
        return this.http.get(MessageService.URL + '/messages').pipe(map(this.convertDataFromServerToMessages));
    }

    public getAllQuestions(): Observable<Message[]> {
        return this.http.get(MessageService.URL + '/questions').pipe(map(this.convertDataFromServerToMessages));
    }
    ...
    public getById(id: number): Observable<Message> {
        return this.http.get(MessageService.URL + '/' + id).pipe(map((message: Message) => new Message(message)));
    }
