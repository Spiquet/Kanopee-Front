...
export class WorkshopComponent implements OnInit {
    ...
    constructor(private workshopService: WorkshopService, public dialog: MatDialog, public userService: UserService) {}
    ...
    deleteWorkshop() {
        this.workshopService.delete(this.workshop.id).subscribe((data: Workshop) => {
