...
export const ProductsMock: Product[] = [
  {
    ...
    description: 'Plante potagère de la famille des Ombellifères, dont la racine le plus souvent rouge, pivotante, au goût légèrement sucré est comestible, et dont certaines espèces sont cultivées comme plantes fourragères.',
    // tslint:disable-next-line: max-line-length
  ...
  },
  {
    title: 'POIVRON ROUGE',
    // tslint:disable-next-line: max-line-length
    description: 'Le poivron est un terme souvent utilisé pour caractériser des variétés de piments doux de l\'espèce Capsicum annuum à très gros fruits (parfois appelé piment au Québec).',
    // tslint:disable-next-line: max-line-length
  ...
  },
  {
    title: 'TOMATES',
    // tslint:disable-next-line: max-line-length
    description: 'Fruit de couleur rouge et de petite taille au goût acidulé s\'apparentant à une tomate classique. Elle se consomme nature, en salade ou cuisinée comme un légume.',
    // tslint:disable-next-line: max-line-length
  ...
  },
  {
    title: 'HARICOTS',
    // tslint:disable-next-line: max-line-length
    description: 'Le Haricot, ou Haricot commun, est une espèce de plantes annuelles de la famille des Fabaceae, du genre Phaseolus, couramment cultivée comme légume ou légumineuse.',
    // tslint:disable-next-line: max-line-length
  ...
  },
  {
    title: 'EPINARDS',
    // tslint:disable-next-line: max-line-length
    description: 'L\'épinard est une plante potagère, annuelle ou bisannuelle, de la famille des Chenopodiaceae ou des Amaranthaceae selon les classifications.',
    // tslint:disable-next-line: max-line-length
