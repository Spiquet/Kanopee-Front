...
export class WorkshopService {
  ...
  public getAll(): Observable<Workshop[]> {
    return this.http
    .get(WorkshopService.URL)
    .pipe(map(this.convertDateFromServerToWorkshops));
  }
  ...
  public getById(id: number): Observable<Workshop> {
    return this.http
    .get(WorkshopService.URL + '/' + id)
    .pipe(map((workshop: Workshop) => new Workshop(workshop)));
  }

  public create(fd: FormData): Observable<any> {
    return this.http
    .post(WorkshopService.URL + '/file' , fd);
  }


  public update(id: number, fd: FormData): Observable<any> {
    return this.http
    .put(WorkshopService.URL + '/fileupload/' + id, fd);
  }

  public delete(id: number): Observable<any> {
    return this.http
    .delete(WorkshopService.URL + '/' + id);
  }
}
